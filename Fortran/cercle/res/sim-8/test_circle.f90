...
Program main
    ...
    continue !! formats
        ...
        94 format('Circle Test @ YYE. Version 1.1.0.. Simulation on ',I4,2('-',I2),'   ',I2,'h',I2)
    ...
    do k = 1, num_points-1
        ...
        do j = 1, n_iter
            ...
            pbb_ana(k) = pbb_ana(k) + (2.0d0 * q_rect)/(pi*j*(j+q_rect*taille)) * (r0/taille)**j * sin(pi*j/(num_points-1)) &
            & * cos(j*(twopi/(num_points-1)*(k-0.5d0)-theta0))
        end do
