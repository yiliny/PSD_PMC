Program main
    ...
    open(unit=36,file=TRIM(rue_total)//"debug_v4.txt"); write(36,94) date(1), date(2), date(3), date(5), date(6)
...
subroutine diffuse(x1, y1, x2, y2, x0, y0, g, rec1, rec2)
    ...
    implicit none
    include "para.h"
    real*8 :: x1,y1, x2,y2, x0,y0, xnew, ynew, xold, yold
