...
Program main
    ...
    continue
        ...
        64 format(5X,'Segment Index',5X,'Hitting Probability')
    ...
    rue_total = "rfl-"
    open(unit=30,file=TRIM(rue_total)//"record.txt"); write(30,94) date(1), date(2), date(3), date(5), date(6)
    ...
    open(unit=34,file=TRIM(rue_total)//"pbb.txt"); write(34,94) date(1), date(2), date(3), date(5), date(6)
    write(34,64); write(34,*)
    !open(unit=35,file=TRIM(rue_total)//"zeta.txt"); write(35,94) date(1), date(2), date(3), date(5), date(6)
    open(unit=36,file=TRIM(rue_total)//"debug.txt"); write(36,94) date(1), date(2), date(3), date(5), date(6); !write(36,*)
    open(unit=37,file=TRIM(rue_total)//"temps.txt"); write(37,94) date(1), date(2), date(3), date(5), date(6); 
